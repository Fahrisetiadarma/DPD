...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && strtolower($role) === 'magang') {
    try {
        if (isset($_POST['add_report'])) {
            ...
            $stmt->execute();
        } elseif (isset($_POST['edit_report']) && (strtolower($role) === 'admin' || strtolower($role) === 'pembimbing')) {
            $id = $_POST['report_id'];
            $link = $_POST['link'];
            $date = $_POST['date'];
            ...
            $stmt->bindParam(':tanggal', $date);
            $stmt->execute();
        } elseif (isset($_POST['delete_report']) && (strtolower($role) === 'admin' || strtolower($role) === 'pembimbing')) {
            $id = $_POST['report_id'];
...
// Ambil data laporan akhir (hanya jika role adalah Admin atau Pembimbing)
$reports = [];
...
<div class="main-content" id="main-content">
    ...
    <div class="content">
        ...
        <?php elseif (strtolower($role) === 'admin' || strtolower($role) === 'pembimbing'): ?>
